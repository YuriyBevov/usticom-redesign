...
$useFancy = $arParams["USE_FANCY"] && $arParams["USE_FANCY"] === "Y";
$useAutoFillMode = $arParams["USE_AUTO_FILL_MODE"] && $arParams["USE_AUTO_FILL_MODE"] === "Y";
...
<section class="section image-slider-section">
	<div class="container">
		...
		<div class="swiper base-slider<?= $useAutoFillMode ? ' --autofill' : '' ?>">
			<div class="swiper-wrapper">
				...
				?>
					<div class="swiper-slide" id="<?= $this->GetEditAreaId($arItem["ID"]) ?>">
						<img <?= $useFancy ? 'data-fancybox="' . $arResult["NAME"] . '"' : '' ?> src="<?= $image["SRC"] ?>" alt="<?= $alt ?>" width="200" height="300">
					</div>
				<? endforeach; ?>
			</div>
