		...
		<div class="content-wrapper">
			<div class="news-header">
				<div class="news-header__side">
					...
					<button class="main-header__request main-btn" type="button" data-modal-anchor="request-modal">Получить консультацию</button>
			...
			<? if ($arResult["IBLOCK_ID"] == 6): ?>
				<p>Больше новостей вы найдете на нашей страничке в <a class="accent-color" href="https://t.me/Usticom" rel="norefferer nofollow noopener">телеграмм</a>, подписывайтесь! </p>
			<? endif; ?>
		</div>
	</div>
</section>
