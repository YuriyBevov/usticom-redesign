			...
			<? foreach ($arResult["ITEMS"] as $arItem): ?>
				...
				<li class="social__list-item">
					<a href="<?= ($arItem["PROPERTIES"]["SOCIAL_LINK"]["VALUE"] ? $arItem["PROPERTIES"]["SOCIAL_LINK"]["VALUE"] : '#') ?>" rel="nofollow noreferrer noopener">
						<?
						$arFile = $arItem["PROPERTIES"]["SOCIAL_ICON_MOBILE"]["VALUE"] ? CFile::GetFileArray($arItem["PROPERTIES"]["SOCIAL_ICON_MOBILE"]["VALUE"]) :  CFile::GetFileArray($arItem["PROPERTIES"]["SOCIAL_ICON"]["VALUE"]);
						?>
