...
<?/*$APPLICATION->IncludeComponent("bitrix:main.include", "", array(
	"AREA_FILE_SHOW" => "file",
		"PATH" => SITE_TEMPLATE_PATH."/include/expiriences-page-header.php"
	),
	false,
	array(
	"ACTIVE_COMPONENT" => "Y"
...
<div class="lw-container-thin info-block">
	...
	<div class="info-block__sidebar"><span class="info-block__sidebar-title">ПОДРОБНЕЕ</span>
		<div class="content-menu">
			...
			<?$APPLICATION->IncludeComponent("bitrix:main.include", "", array(
	"AREA_FILE_SHOW" => "file",
		"PATH" => SITE_TEMPLATE_PATH."/include/expiriences-page-sidebar-links.php"
	),
	false,
	array(
	"ACTIVE_COMPONENT" => "N"
	...
	<div class="info-block__content">
		<h1 class="lw-section-title visually-hidden">События</h1>
		<!--Новости-->
		<?$APPLICATION->IncludeComponent(
	"bitrix:news.list", 
